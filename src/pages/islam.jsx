    ...
    <div className="min-h-screen bg-gray-100 p-6">
      ...
      <div className="mt-10 bg-white p-6 rounded-xl shadow-md">
        ...
        <p className="text-lg leading-8 text-gray-700">
          ...
          Islam is the religion revealed by
          Allah سبحانه وتعالى to Prophet
          Muhammad ﷺ.
        ...
        <p className="text-lg leading-8 text-gray-700 mt-4">
          ...
          Islam teaches people how to worship
          Allah, build good character,
          establish justice, and live a
          meaningful life.
      ...
      <div className="mt-10 bg-white p-6 rounded-xl shadow-md">
        ...
        <p className="text-lg leading-8 text-gray-700">
          ...
          Any human being can become Muslim,
        ...
        <p className="text-lg leading-8 text-gray-700 mt-4">
          ...
          A person enters Islam by sincerely
          believing that:

        </p>

        <ul className="list-disc ml-8 mt-4 text-gray-700 space-y-3">
      ...
      <div className="mt-10 bg-white p-6 rounded-xl shadow-md">
        ...
        <div className="space-y-4 text-lg text-gray-700">
          ...
          <div>
            <strong>1. Shahadah:</strong>
            {" "}
            Testifying that only Allah deserves worship
            and Muhammad ﷺ is His Messenger.
          </div>

          <div>
            <strong>2. Salah:</strong>
            {" "}
            Performing the five daily prayers.
          </div>

          <div>
            <strong>3. Zakat:</strong>
            {" "}
            Giving charity to the needy.
          </div>

          <div>
            <strong>4. Sawm:</strong>
            {" "}
            Fasting during Ramadan.
          </div>

          <div>
            <strong>5. Hajj:</strong>
            {" "}
            Pilgrimage to Makkah for those able.
          </div>
